...
/**
* @brief rearms chosen timer with different timer interval
* @param timer_num: timer to be rearmed
* @param TimerInterval: new interval
**/
void rearm_timer(uint8_t timer_num, uint32_t TimerInterval){
