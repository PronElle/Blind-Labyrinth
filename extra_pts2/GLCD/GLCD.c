...
/**
* @brief draws a rectangle of given size and color at given position
* @param x      : x coord with respect to display system 
* @param y      : y coord with respect to display system 
* @param height : rectangle's height
* @param width  : rectangle's width
* @param color  : rectangle's color
* @return None
***/
void LCD_drawRectangle(uint16_t x, uint16_t y, uint16_t heigth, uint16_t width, uint16_t color) {
	uint16_t i, j;
